...
@if(count($properties) > 0)
            ...
            @php
                ...
                $property_sum_sanitised = substr($property_sum_stripped, 0, 150);
            @endphp
    <div class="col-sm-4 col-12 mb-5">
        ...
        <div class="property-grid{{ $property['featured'] ?? false ? ' property-grid__featured' : '' }}">
            <div class="property__img">
                ...
                @else
                    <img src="/wp-content/uploads/2023/03/logo.png" alt="Awaiting Images for {{ $property['Address']['display_address'] }}">
                @endif
                </a>
            </div>

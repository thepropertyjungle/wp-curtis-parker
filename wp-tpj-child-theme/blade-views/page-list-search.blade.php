...
<div class="container">
    ...
    <div class="row my-4 py-3">
        <div class="col-sm-12 col-md-3 d-flex align-items-center">
            ...
            <span class="styled-select">
                <select 
                    ...
                    data-form-url="{{ $global_options['dynamic_options']['search_results_list']['permalink'] ?? '' }}"
        ...
        <div class="col-sm-12 col-md d-flex align-items-center justify-content-sm-center justify-content-md-end">
            ...
            Grid View </a>
            <a
            href="{{ $global_options['dynamic_options']['search_results_map']['permalink'] ?? '' }}@php _e_blade_query_string() @endphp"
            class="view-btn"
    ...
    <div class="row">
        ...
        <!-- <div class="col-sm-4">
            ...
            @include('components/shortlist-sidebar')
        </div> -->
    </div>
</div>
